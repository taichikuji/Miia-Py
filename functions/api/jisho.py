    ...
    def _parse(self, keyword, response=[]):
        ...
        for data in response:
            ...
            for sense in data["senses"]:
                ...
                sense["parts_of_speech"].extend(sense.get("parts_of_speech", ()))
    ...
    def jisho_embed(self, keywords, stats_json):
        ...
        for start, res in enumerate(stats_json, 1):
            ...
            em = {
                ...
                "fields": [
                    {"name": "Words", "value": res["words"]},
                    {"name": "Kanji", "value": res["kanji"]},
                    {"name": "Readings", "value": res["readings"]},
                    {"name": "Parts of Speech", "value": res["parts_of_speech"]},
                    {"name": "Meanings", "value": res["english"]},
                ],
