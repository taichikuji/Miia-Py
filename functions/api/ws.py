...
class api(commands.Cog):
    ...
    def unit_value(self, args):
        ...
        if args:
            ...
            unit = {"temp": "°C", "speed": "m/s"}
            params = {"unit": "metric", "city": "Madrid"}
        return unit, params
    ...
    def weather_embed(self, stats_json_array, unit):
        try:
            ...
            em = {
                ...
                "thumbnail": {
                    "url": f"https://openweathermap.org/img/wn/{ws['weather'][0]['icon']}@2x.png"
                },
                "fields": [
                    {
                        "name": "Weather",
                    ...
                    {
                        "name": "Time",
                        "value": f"**Sunrise**: {datetime.fromtimestamp(ws['sys']['sunrise']+ws['timezone']).strftime('%H:%M')}\n"
